...
Including creating dummy variables, rcs terms, and interaction terms; and create `y` with pre-determined formula. For details of all the `step_` functions, see `centering.R`.
