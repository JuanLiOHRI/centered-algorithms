...
1. __Method 1__: Centering the vatiable `x_4` first, then get the rcs terms of the new centered vatiable.

2. __Method 2__: Get the rcs terms of the orginial `x_4` first, then centering each rcs term.

I'll use below example to show that __Method 2__ is preferred.
...
#### __Method 1__: centering first, then rcs
...
#### __Method 2__: rcs first, then centering
