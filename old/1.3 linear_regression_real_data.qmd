...
```{r}
res <- calibration(test_means_train$pred.o, test_means_train$charges, labelPos.x = 11000, labelPos.y = 50000, marginPlt = TRUE)
```

```{r}
# To confirm that this is identical to above
res <- calibration(test_means_train$pred.c, test_means_train$charges, labelPos.x = 11000, labelPos.y = 50000, marginPlt = TRUE)
```

```{r}
res <- calibration(test_means_test$pred.c, test_means_test$charges, labelPos.x = 11000, labelPos.y = 50000, marginPlt = TRUE)
```
