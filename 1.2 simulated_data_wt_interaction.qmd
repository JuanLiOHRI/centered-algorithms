...
step_rcs <- function(df, knots) {
  k_x4 <- length(knots)
  res <- get_rcs(df$x4, knots)
...
means <- c(
  ...
  mean(data$x2_cat2),
  mean(data$x2_cat3),
  mean(data$x1_cat2_by_x2_cat2),
  mean(data$x1_cat2_by_x2_cat3),
  mean(data$x3),
  mean(data$x2_cat2_by_x3),
  mean(data$x2_cat3_by_x3),
  mean(data$x5),
  mean(data$x3_by_x5),
  mean(data$x4_rcs_1),
  mean(data$x4_rcs_2),
  mean(data$x4_rcs_3),
  mean(data$x2_cat2_by_x4_rcs_1),
  mean(data$x2_cat3_by_x4_rcs_1),
  mean(data$x2_cat2_by_x4_rcs_2),
  mean(data$x2_cat3_by_x4_rcs_2),
  mean(data$x2_cat2_by_x4_rcs_3),
  mean(data$x2_cat3_by_x4_rcs_3),
  mean(data$x3_by_x4_rcs_1),
  mean(data$x3_by_x4_rcs_2),
  mean(data$x3_by_x4_rcs_3)
)
vars <- c(
  "x1_cat2",
  "x2_cat2",
...
step_center <- function(df, means) {
  df <- df %>%
    mutate(
      ...
      x1_cat2_by_x2_cat2_C = x1_cat2_by_x2_cat2 - means["x1_cat2_by_x2_cat2"],
      x1_cat2_by_x2_cat3_C = x1_cat2_by_x2_cat3 - means["x1_cat2_by_x2_cat3"],
      x3_C = x3 - means["x3"],
      x2_cat2_by_x3_C = x2_cat2_by_x3 - means["x2_cat2_by_x3"],
      x2_cat3_by_x3_C = x2_cat3_by_x3 - means["x2_cat3_by_x3"],
      x5_C = x5 - means["x5"],
      x3_by_x5_C = x3_by_x5 - means["x3_by_x5"],
      x4_rcs_1_C = x4_rcs_1 - means["x4_rcs_1"],
      x4_rcs_2_C = x4_rcs_2 - means["x4_rcs_2"],
      x4_rcs_3_C = x4_rcs_3 - means["x4_rcs_3"],
      x2_cat2_by_x4_rcs_1_C = x2_cat2_by_x4_rcs_1 - means["x2_cat2_by_x4_rcs_1"],
      x2_cat3_by_x4_rcs_1_C = x2_cat3_by_x4_rcs_1 - means["x2_cat3_by_x4_rcs_1"],
      x2_cat2_by_x4_rcs_2_C = x2_cat2_by_x4_rcs_2 - means["x2_cat2_by_x4_rcs_2"],
      x2_cat3_by_x4_rcs_2_C = x2_cat3_by_x4_rcs_2 - means["x2_cat3_by_x4_rcs_2"],
      x2_cat2_by_x4_rcs_3_C = x2_cat2_by_x4_rcs_3 - means["x2_cat2_by_x4_rcs_3"],
      x2_cat3_by_x4_rcs_3_C = x2_cat3_by_x4_rcs_3 - means["x2_cat3_by_x4_rcs_3"],
      x3_by_x4_rcs_1_C = x3_by_x4_rcs_1 - means["x3_by_x4_rcs_1"],
      x3_by_x4_rcs_2_C = x3_by_x4_rcs_2 - means["x3_by_x4_rcs_2"],
      x3_by_x4_rcs_3_C = x3_by_x4_rcs_3 - means["x3_by_x4_rcs_3"]
    )
...
set.seed(100)
test <- sample_n(data %>% select(x1:x5, y), 100)
